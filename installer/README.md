...
Test the installed Start-menu entries for **Start DCS Radio Voice Control**, **Configure DCS Radio Voice Control**, **Repair DCS Radio Voice Control** and **Download DCS Radio Voice Control update**, then test removal through Windows **Installed apps**. Normal uninstall preserves configuration/aliases unless the user explicitly chooses to delete them.
